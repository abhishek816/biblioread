...
<!-- Mirrored from demo.templatesjungle.com/booksaw/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Apr 2023 13:51:57 GMT -->
<head>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="right-element">
						<a href="login.php" class="user-account for-buy"><i class="icon icon-user"></i><span>Account</span></a>
	...
	<header id="header">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2">
					<div class="main-logo">
						<a href="index-2.html"><img src="images\main-logo1.png" alt="logo"></a>
					</div>
							...
							<ul class="menu-list">
								...
								<li class="menu-item has-sub">
									...
									<ul>
								        ...
								        <li><a href="audiobook.php">Audibook</a></li>
								        <li><a href="styles.html">Reviews</a></li>
			...
			<div class="col-md-4">
				...
				<div class="footer-item">
					<div class="company-brand">
						...
						<p>WHEN BIBLIOPHILES MEET HEAVEN!</p>
					</div>
				</div>
